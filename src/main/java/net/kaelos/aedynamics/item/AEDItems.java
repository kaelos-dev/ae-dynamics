...
public class AEDItems {
    ...
    public static final RegistryObject<Item> CELL_COMPONENT_1024K = ITEMS.register("cell_component_1024k",
            () -> new StorageComponentItem(new Item.Properties(), 1024));
    public static final RegistryObject<Item> CELL_COMPONENT_4096K = ITEMS.register("cell_component_4096k",
            () -> new StorageComponentItem(new Item.Properties(), 4096));
    public static final RegistryObject<Item> CELL_COMPONENT_16384K = ITEMS.register("cell_component_16384k",
            () -> new StorageComponentItem(new Item.Properties(), 16384));
    public static final RegistryObject<Item> CELL_COMPONENT_65536K = ITEMS.register("cell_component_65536k",
            () -> new StorageComponentItem(new Item.Properties(), 65536));
    public static final RegistryObject<Item> CELL_COMPONENT_262144K = ITEMS.register("cell_component_262144k",
            () -> new StorageComponentItem(new Item.Properties(), 262144));

    public static final RegistryObject<Item> ITEM_STORAGE_CELL_1024K = ITEMS.register("item_storage_cell_1024k",
    ...
    public static final RegistryObject<Item> ITEM_STORAGE_CELL_4096K = ITEMS.register("item_storage_cell_4096k",
    ...
    public static final RegistryObject<Item> ITEM_STORAGE_CELL_16384K = ITEMS.register("item_storage_cell_16384k",
    ...
    public static final RegistryObject<Item> ITEM_STORAGE_CELL_65536K = ITEMS.register("item_storage_cell_65536k",
    ...
    public static final RegistryObject<Item> ITEM_STORAGE_CELL_262144K = ITEMS.register("item_storage_cell_262144k",
