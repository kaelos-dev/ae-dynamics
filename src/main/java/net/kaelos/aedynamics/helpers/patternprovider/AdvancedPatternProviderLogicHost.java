...
public interface AdvancedPatternProviderLogicHost extends PatternProviderLogicHost {
    AdvancedPatternProviderLogic getLogic();
    ...
    default void openMenu(Player player, MenuLocator locator) {
        MenuOpener.open(AdvancedPatternProviderMenu.TYPE, player, locator);
    }

    @Override
    default void returnToMainMenu(Player player, ISubMenu subMenu) {
        MenuOpener.returnTo(AdvancedPatternProviderMenu.TYPE, player, subMenu.getLocator());
    }
