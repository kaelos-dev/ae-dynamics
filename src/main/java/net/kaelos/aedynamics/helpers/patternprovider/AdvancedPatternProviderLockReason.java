...
import net.kaelos.aedynamics.client.screen.AdvancedPatternProviderScreen;
...
public class AdvancedPatternProviderLockReason implements ICompositeWidget {
    protected boolean visible = false;
    protected int x;
    protected int y;

    private final AdvancedPatternProviderScreen<?> screen;

    public AdvancedPatternProviderLockReason(AdvancedPatternProviderScreen<?> screen) {
        this.screen = screen;
    }
